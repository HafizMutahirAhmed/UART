...
VL_ATTR_COLD void VUART_TestBench___024root__trace_init_sub__TOP__0(VUART_TestBench___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+12,0,"EN",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+13,0,"Reset",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+14,0,"DataIN",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    ...
    tracep->declBus(c+14,0,"DataIN",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    ...
    tracep->declBit(c+3,0,"BaudTick",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->pushPrefix("BaudGen", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->declBit(c+11,0,"CLK",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+13,0,"Reset",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+3,0,"BaudTick",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+15,0,"MAX_COUNT",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 12,0);
    tracep->declBus(c+4,0,"count",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 12,0);
    tracep->popPrefix();
    tracep->pushPrefix("RX", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->declBit(c+3,0,"BaudTick",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+11,0,"CLK",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+13,0,"Reset",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+8,0,"databuffer",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+9,0,"count",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+10,0,"state",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
    tracep->popPrefix();
    tracep->popPrefix();
    tracep->popPrefix();
}
...
VL_ATTR_COLD void VUART_TestBench___024root__trace_const_0_sub_0(VUART_TestBench___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullSData(oldp+15,(0x1458U),13);
}
...
VL_ATTR_COLD void VUART_TestBench___024root__trace_full_0_sub_0(VUART_TestBench___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+3,(vlSelf->UART_TestBench__DOT__DUT__DOT__BaudTick));
    bufp->fullSData(oldp+4,(vlSelf->UART_TestBench__DOT__DUT__DOT__BaudGen__DOT__count),13);
    bufp->fullCData(oldp+5,(vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__state),2);
    bufp->fullCData(oldp+6,(vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__databuffer),8);
    bufp->fullCData(oldp+7,(vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__count),3);
    bufp->fullCData(oldp+8,(vlSelf->UART_TestBench__DOT__DUT__DOT__TX__DOT__databuffer),8);
    bufp->fullCData(oldp+9,(vlSelf->UART_TestBench__DOT__DUT__DOT__TX__DOT__count),8);
    bufp->fullCData(oldp+10,(vlSelf->UART_TestBench__DOT__DUT__DOT__TX__DOT__state),2);
    bufp->fullBit(oldp+11,(vlSelf->UART_TestBench__DOT__CLK));
    bufp->fullBit(oldp+12,(vlSelf->UART_TestBench__DOT__EN));
    bufp->fullBit(oldp+13,(vlSelf->UART_TestBench__DOT__Reset));
    bufp->fullCData(oldp+14,(vlSelf->UART_TestBench__DOT__DataIN),8);
}
