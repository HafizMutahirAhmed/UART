...
VL_INLINE_OPT VlCoroutine VUART_TestBench___024root___eval_initial__TOP__Vtiming__0(VUART_TestBench___024root* vlSelf) {
    ...
    vlSelf->UART_TestBench__DOT__DataIN = 0U;
    vlSelf->UART_TestBench__DOT__ParityType = 0U;
    co_await vlSelf->__VdlySched.delay(5ULL, nullptr, 
                                       "UART_TestBench.sv", 
                                       28);
    vlSelf->UART_TestBench__DOT__Reset = 0U;
    vlSelf->UART_TestBench__DOT__ParityType = 0U;
    vlSelf->UART_TestBench__DOT__DataIN = 0xaaU;
    vlSelf->UART_TestBench__DOT__EN = 1U;
    co_await vlSelf->__VdlySched.delay(0x190ULL, nullptr, 
                                       "UART_TestBench.sv", 
                                       34);
    vlSelf->UART_TestBench__DOT__ParityType = 1U;
    vlSelf->UART_TestBench__DOT__DataIN = 0x55U;
    vlSelf->UART_TestBench__DOT__EN = 1U;
    co_await vlSelf->__VdlySched.delay(0x190ULL, nullptr, 
                                       "UART_TestBench.sv", 
                                       40);
    vlSelf->UART_TestBench__DOT__ParityType = 0U;
    vlSelf->UART_TestBench__DOT__DataIN = 0xf0U;
    vlSelf->UART_TestBench__DOT__EN = 1U;
    co_await vlSelf->__VdlySched.delay(0x190ULL, nullptr, 
                                       "UART_TestBench.sv", 
                                       46);
    vlSelf->UART_TestBench__DOT__ParityType = 1U;
    vlSelf->UART_TestBench__DOT__DataIN = 0xfU;
    vlSelf->UART_TestBench__DOT__EN = 1U;
    co_await vlSelf->__VdlySched.delay(0x190ULL, nullptr, 
                                       "UART_TestBench.sv", 
                                       52);
    ...
    co_await vlSelf->__VdlySched.delay(0x190ULL, nullptr, 
                                       "UART_TestBench.sv", 
                                       64);
    VL_FINISH_MT("UART_TestBench.sv", 66, "");
}
...
VL_INLINE_OPT void VUART_TestBench___024root___nba_sequent__TOP__0(VUART_TestBench___024root* vlSelf) {
    ...
    // Init
    SData/*12:0*/ __Vdly__UART_TestBench__DOT__DUT__DOT__BaudGen__DOT__count;
    __Vdly__UART_TestBench__DOT__DUT__DOT__BaudGen__DOT__count = 0;
    CData/*2:0*/ __Vdly__UART_TestBench__DOT__DUT__DOT__TX__DOT__state;
    ...
    CData/*2:0*/ __Vdly__UART_TestBench__DOT__DUT__DOT__RX__DOT__state;
    __Vdly__UART_TestBench__DOT__DUT__DOT__RX__DOT__state = 0;
    // Body
    __Vdly__UART_TestBench__DOT__DUT__DOT__BaudGen__DOT__count 
        = vlSelf->UART_TestBench__DOT__DUT__DOT__BaudGen__DOT__count;
    ...
    if (vlSelf->UART_TestBench__DOT__Reset) {
        ...
        vlSelf->UART_TestBench__DOT__ParityError = 0U;
        __Vdly__UART_TestBench__DOT__DUT__DOT__TX__DOT__state = 0U;
        __Vdly__UART_TestBench__DOT__DUT__DOT__BaudGen__DOT__count = 0U;
        vlSelf->UART_TestBench__DOT__DUT__DOT__BaudTick = 0U;
    } else {
        if (vlSelf->UART_TestBench__DOT__DUT__DOT__BaudTick) {
            if ((4U & (IData)(vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__state))) {
                __Vdly__UART_TestBench__DOT__DUT__DOT__RX__DOT__state = 0U;
            } else if ((2U & (IData)(vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__state))) {
                if ((1U & (IData)(vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__state))) {
                    vlSelf->UART_TestBench__DOT__DataOUT 
                        = vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__databuffer;
                    __Vdly__UART_TestBench__DOT__DUT__DOT__RX__DOT__state = 0U;
                } else {
                    vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__computed_parity 
                        = (1U & ((IData)(vlSelf->UART_TestBench__DOT__ParityType)
                                  ? (~ VL_REDXOR_8(vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__databuffer))
                                  : VL_REDXOR_8(vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__databuffer)));
                    vlSelf->UART_TestBench__DOT__ParityError 
                        = ((IData)(vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__computed_parity) 
                           != (IData)(vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__parity_bit));
                    __Vdly__UART_TestBench__DOT__DUT__DOT__RX__DOT__state = 3U;
                    vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__parity_bit 
                ...
                vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__databuffer 
                    = (((~ ((IData)(1U) << (IData)(vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__count))) 
                        & (IData)(vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__databuffer)) 
                ...
                vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__databuffer = 0U;
                vlSelf->UART_TestBench__DOT__DataOUT = 0U;
                vlSelf->UART_TestBench__DOT__ParityError = 0U;
                if ((1U & (~ (IData)(vlSelf->UART_TestBench__DOT__DUT__DOT__tx)))) {
                    vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__count = 7U;
                    __Vdly__UART_TestBench__DOT__DUT__DOT__RX__DOT__state = 1U;
                }
            }
            if ((4U & (IData)(vlSelf->UART_TestBench__DOT__DUT__DOT__TX__DOT__state))) {
                if ((2U & (IData)(vlSelf->UART_TestBench__DOT__DUT__DOT__TX__DOT__state))) {
                    __Vdly__UART_TestBench__DOT__DUT__DOT__TX__DOT__state = 0U;
                ...
                if ((1U & (IData)(vlSelf->UART_TestBench__DOT__DUT__DOT__TX__DOT__state))) {
                    vlSelf->UART_TestBench__DOT__DUT__DOT__tx 
                        = vlSelf->UART_TestBench__DOT__DUT__DOT__TX__DOT__parity_bit;
                    __Vdly__UART_TestBench__DOT__DUT__DOT__TX__DOT__state = 4U;
                } else {
                    __Vdly__UART_TestBench__DOT__DUT__DOT__TX__DOT__count 
                ...
                vlSelf->UART_TestBench__DOT__DUT__DOT__TX__DOT__parity_bit 
                    = (1U & ((IData)(vlSelf->UART_TestBench__DOT__ParityType)
                              ? (~ VL_REDXOR_8(vlSelf->UART_TestBench__DOT__DataIN))
                              : VL_REDXOR_8(vlSelf->UART_TestBench__DOT__DataIN)));
        ...
        if ((0xfU == (IData)(vlSelf->UART_TestBench__DOT__DUT__DOT__BaudGen__DOT__count))) {
            __Vdly__UART_TestBench__DOT__DUT__DOT__BaudGen__DOT__count = 0U;
            vlSelf->UART_TestBench__DOT__DUT__DOT__BaudTick = 1U;
        } else {
            __Vdly__UART_TestBench__DOT__DUT__DOT__BaudGen__DOT__count 
                = (0x1fffU & ((IData)(1U) + (IData)(vlSelf->UART_TestBench__DOT__DUT__DOT__BaudGen__DOT__count)));
            vlSelf->UART_TestBench__DOT__DUT__DOT__BaudTick = 0U;
        }
    }
    vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__state 
...
#endif
            VL_FATAL_MT("UART_TestBench.sv", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("UART_TestBench.sv", 1, "", "Active region did not converge.");
            }
