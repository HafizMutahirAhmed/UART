...
void VUART_TestBench___024root__trace_chg_0_sub_0(VUART_TestBench___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgCData(oldp+2,(vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__state),2);
        bufp->chgCData(oldp+3,(vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__databuffer),8);
        bufp->chgCData(oldp+4,(vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__count),3);
        bufp->chgCData(oldp+5,(vlSelf->UART_TestBench__DOT__DUT__DOT__TX__DOT__databuffer),8);
        bufp->chgCData(oldp+6,(vlSelf->UART_TestBench__DOT__DUT__DOT__TX__DOT__count),8);
        bufp->chgCData(oldp+7,(vlSelf->UART_TestBench__DOT__DUT__DOT__TX__DOT__state),2);
    }
    bufp->chgBit(oldp+8,(vlSelf->UART_TestBench__DOT__CLK));
    bufp->chgBit(oldp+9,(vlSelf->UART_TestBench__DOT__EN));
    bufp->chgBit(oldp+10,(vlSelf->UART_TestBench__DOT__Reset));
    bufp->chgCData(oldp+11,(vlSelf->UART_TestBench__DOT__DataIN),8);
}
