...
class alignas(VL_CACHE_LINE_BYTES) VUART_TestBench___024root final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ UART_TestBench__DOT__ParityType;
    CData/*0:0*/ UART_TestBench__DOT__ParityError;
    CData/*0:0*/ UART_TestBench__DOT__DUT__DOT__tx;
    CData/*0:0*/ UART_TestBench__DOT__DUT__DOT__BaudTick;
    CData/*7:0*/ UART_TestBench__DOT__DUT__DOT__TX__DOT__databuffer;
    CData/*7:0*/ UART_TestBench__DOT__DUT__DOT__TX__DOT__count;
    CData/*0:0*/ UART_TestBench__DOT__DUT__DOT__TX__DOT__parity_bit;
    CData/*2:0*/ UART_TestBench__DOT__DUT__DOT__TX__DOT__state;
    CData/*2:0*/ UART_TestBench__DOT__DUT__DOT__RX__DOT__state;
    CData/*7:0*/ UART_TestBench__DOT__DUT__DOT__RX__DOT__databuffer;
    CData/*2:0*/ UART_TestBench__DOT__DUT__DOT__RX__DOT__count;
    CData/*0:0*/ UART_TestBench__DOT__DUT__DOT__RX__DOT__parity_bit;
    CData/*0:0*/ UART_TestBench__DOT__DUT__DOT__RX__DOT__computed_parity;
    CData/*0:0*/ __Vtrigprevexpr___TOP__UART_TestBench__DOT__CLK__0;
    CData/*0:0*/ __VactContinue;
    SData/*12:0*/ UART_TestBench__DOT__DUT__DOT__BaudGen__DOT__count;
