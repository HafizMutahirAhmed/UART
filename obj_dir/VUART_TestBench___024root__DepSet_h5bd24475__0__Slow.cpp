...
VL_ATTR_COLD void VUART_TestBench___024root___eval_static__TOP(VUART_TestBench___024root* vlSelf);
...
VL_ATTR_COLD void VUART_TestBench___024root___eval_static(VUART_TestBench___024root* vlSelf) {
    ...
    // Body
    VUART_TestBench___024root___eval_static__TOP(vlSelf);
...
VL_ATTR_COLD void VUART_TestBench___024root___eval_static__TOP(VUART_TestBench___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VUART_TestBench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VUART_TestBench___024root___eval_static__TOP\n"); );
    // Body
...
VL_ATTR_COLD void VUART_TestBench___024root___ctor_var_reset(VUART_TestBench___024root* vlSelf) {
    ...
    vlSelf->UART_TestBench__DOT__ParityType = VL_RAND_RESET_I(1);
    vlSelf->UART_TestBench__DOT__ParityError = VL_RAND_RESET_I(1);
    vlSelf->UART_TestBench__DOT__DUT__DOT__tx = VL_RAND_RESET_I(1);
    vlSelf->UART_TestBench__DOT__DUT__DOT__BaudTick = VL_RAND_RESET_I(1);
    vlSelf->UART_TestBench__DOT__DUT__DOT__BaudGen__DOT__count = VL_RAND_RESET_I(13);
    ...
    vlSelf->UART_TestBench__DOT__DUT__DOT__TX__DOT__parity_bit = VL_RAND_RESET_I(1);
    vlSelf->UART_TestBench__DOT__DUT__DOT__TX__DOT__state = VL_RAND_RESET_I(3);
    vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__state = VL_RAND_RESET_I(3);
    ...
    vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__parity_bit = VL_RAND_RESET_I(1);
    vlSelf->UART_TestBench__DOT__DUT__DOT__RX__DOT__computed_parity = VL_RAND_RESET_I(1);
